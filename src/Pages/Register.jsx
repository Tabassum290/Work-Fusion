...
const Register = () => {
    const {user,setUser,createNewUser,loading,setLoading,profileUpdate,googleProvider} = useContext(AuthContext);
                    ...
                    .then(() => {
                       ...
                       .then(res => {
                        ...
                        if(res.data.insertedId){
                            ...
                            navigate('/');
                            Swal.fire("Sign Up Successful", "Welcome to Bistro Boss!", "success");
                        }
                       })
...
<div className="w-full max-w-lg p-8 space-y-3 rounded-xl dark:bg-gray-50 dark:text-gray-800 mx-auto">
	...
	<form onSubmit={handleSignUp} className="space-y-6">
		...
		<div className="space-y-1 text-sm">
			...
			<input type="text" name="photo" placeholder="Type here" className="w-full px-4 py-3 rounded-md dark:border-gray-300 dark:bg-gray-50 dark:text-gray-800 focus:dark:border-violet-600" />
		</div>
		<div className="space-y-1 text-sm">
        ...
        <button className="btn bg-[#856432b3] w-full p-3 text-center text-white rounded-sm dark:text-white dark:bg-violet-600">Sign in</button>
	</form>
